...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      putTrainScheduleExceptionById: build.mutation<
        PutTrainScheduleExceptionByIdApiResponse,
        PutTrainScheduleExceptionByIdApiArg
      >({
        query: (queryArg) => ({
          url: `/train_schedule_exception/${queryArg.id}`,
          method: 'PUT',
          body: queryArg.body,
        }),
        invalidatesTags: ['train_schedule_exceptions'],
      ...
      getTrainSchedulesByIdEtcsBrakingCurves: build.query<
        ...
        GetTrainSchedulesByIdEtcsBrakingCurvesApiArg
      >({
        query: (queryArg) => ({
          url: `/train_schedules/${queryArg.id}/etcs_braking_curves`,
          params: {
            infra_id: queryArg.infraId,
            electrical_profile_set_id: queryArg.electricalProfileSetId,
      ...
      getTrainSchedulesByIdSimulation: build.query<
        ...
        GetTrainSchedulesByIdSimulationApiArg
      >({
        query: (queryArg) => ({
          url: `/train_schedules/${queryArg.id}/simulation`,
          params: {
            infra_id: queryArg.infraId,
            electrical_profile_set_id: queryArg.electricalProfileSetId,
            exception_id: queryArg.exceptionId,
...
export type PutTrainScheduleExceptionByIdApiResponse = unknown;
export type PutTrainScheduleExceptionByIdApiArg = {
  /** An exception ID */
  id: number;
  body: {
    change_groups: TrainScheduleExceptionChangeGroups;
...
export type GetTrainSchedulesByIdEtcsBrakingCurvesApiArg = {
  id: number;
  infraId: number;
  electricalProfileSetId?: number;
  exceptionId?: number;
...
export type GetTrainSchedulesByIdSimulationApiArg = {
  id: number;
  infraId: number;
  electricalProfileSetId?: number;
  exceptionId?: number;
