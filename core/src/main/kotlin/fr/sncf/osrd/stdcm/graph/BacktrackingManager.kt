    ...
    private fun rebuildEdgeBackward(old: STDCMEdge, endSpeed: Double): STDCMEdge? {
        val oldEnvelope =
            graph.stdcmSimulations.simulateBlock(
                old.infraExplorer.getCurrentRollingStock(),
                graph.comfort,
                graph.timeStep,
                graph.tag,
                ...
                BlockSimulationParameters(
                    ...
                    old.beginSpeed,
                    old.infraExplorer.getStepTracker().iterateReachedStepsBackwards().count {
                        it.isPlanned
                    },
        ...
        val context =
            build(old.infraExplorer.getCurrentRollingStock(), path, graph.timeStep, graph.comfort)
